...
ClaudeCode must replace this status with exact evidence while executing the plan. Do not mark Phase 48 complete when any required gate is skipped or blocked; record the blocker and leave the status INCOMPLETE.
