...
# ── Output files check (agent-extraction-only: these are generated by pipeline later) ──
# CSV/MD files come from deterministic pipeline (write_agent_outputs.py), not agent extraction.
